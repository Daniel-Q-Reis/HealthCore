...
---
[![CI Pipeline](https://github.com/Daniel-Q-Reis/cookiecutter/actions/workflows/ci.yml/badge.svg)](https://github.com/Daniel-Q-Reis/cookiecutter/actions/workflows/ci.yml)

> ### A Note on the CI/CD Status
> The CI/CD pipeline for this template repository itself is expected to fail. This is by design. The `.github/workflows/ci.yml` file is configured to work on a **project generated by this template**, not on the template source itself. This ensures that any new project you start comes with a fully functional CI pipeline out-of-the-box.
